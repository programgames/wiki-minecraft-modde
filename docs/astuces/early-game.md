...
=== "JEI Tips"
    ...
    !!! example "Recherches Utiles"
        ...
        - `bee` - Options d'apiculture
        - `seed` - Toutes les graines disponibles
        - `pig` - Farming de cochons
        - `chicken` - Options de poulets
        - `iron` - Comment produire du fer
        - `Autofeeder` - Nourriture automatique
        - `Menril` - Arbre Menril (Integrated Dynamics)
...
- [:octicons-arrow-right-24: Getting Started](getting-started.md) - Les tout premiers pas dans le modpack
- [:octicons-arrow-right-24: Mid-Game Guide](mid-game.md) - Transition vers l'automatisation et le stockage digital
- [:octicons-arrow-right-24: Erreurs Communes](erreurs-communes.md) - Les pièges à éviter en début de partie
- [:octicons-arrow-right-24: Raccourcis Clavier](keybinds.md) - Configurer les keybinds essentiels
